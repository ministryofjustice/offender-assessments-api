...
public class SentencePlansController {
    ...
    @ApiResponses({
            @ApiResponse(code = 404, message = "Offender not found"),
            @ApiResponse(code = 200, message = "OK")})
    public ResponseEntity<Collection<FullSentencePlanSummaryDto>> getSummarySentencePlansForOffender(@PathVariable("identityType") String identityType,
                                                                                                     @PathVariable("identity") String identity,
                                                                                                     @RequestParam(value = "historicStatus", required = false) String filterGroupStatus,
                                                                                                     @RequestParam(value = "assessmentType", required = false) String filterAssessmentType,
                                                                                                     @RequestParam(value = "voided", required = false) Boolean filterVoided,
        ...
        var plans = sentencePlanService.getFullSentencePlanSummariesForOffender(identityType, identity, filterGroupStatus, filterAssessmentType, filterVoided, filterAssessmentStatus);
